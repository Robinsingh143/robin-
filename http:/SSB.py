...
header_grup = {"user-agent": "*_WhatsApp/2.12.81 (Windows NT 6.1; U; es-ES) Presto/2.9.181 Version/12.00;]"}
        ...
        try:
            for pw in __chi__:
                ...
                header = {
                    ...
                    "user-agent":"WhatsApp/2.16.352 Mozilla/5.0 (Linux; Android 5.1.1; SAMSUNG SM-G925F Build/LMY47X) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/3.2 Chrome/38.0.2125.102  Safari/537.36+",
